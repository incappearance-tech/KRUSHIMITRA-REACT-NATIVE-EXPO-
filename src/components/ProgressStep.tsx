...
export const ProgressStep: React.FC<ProgressStepProps> = ({ currentStep, totalSteps, label }) => {
...
const styles = StyleSheet.create({
  ...
  barBackground: { height: 8, backgroundColor: '#dcfce7', borderRadius: 4, overflow: 'hidden' },
