    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.sectionCard}>
                    <View style={styles.cardHeader}>
                        ...
                        <TouchableOpacity onPress={() => handleEditSection('/(farmer)/rent-out/add-machine')}>
                    ...
                    <View style={styles.machineRow}>
                        <View style={styles.machineImageWrap}>
                            {machineData.image ? (
                                <Image source={{ uri: machineData.image }} style={styles.machineThumb} />
                            ) : (
                ...
                <View style={styles.sectionCard}>
                    <View style={styles.cardHeader}>
                        ...
                        <TouchableOpacity onPress={() => handleEditSection('/(farmer)/rent-out/preferences')}>
                            <Text style={styles.editLink}>Edit</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.gridRow}>
                        <View style={styles.gridItem}>
                            ...
                            <Text style={styles.gridValue}>₹{machineData.price} <Text style={styles.unitText}>{machineData.priceUnit}</Text></Text>
                        </View>
                        <View style={styles.gridItem}>
                ...
                <View style={styles.sectionCard}>
                    <View style={styles.cardHeader}>
                        <View style={styles.cardTitleRow}>
                            <MaterialIcons name="calendar-today" size={20} color={COLORS.brand.primary} />
                            <Text style={styles.cardTitle}>Available Dates</Text>
                        </View>
                        <TouchableOpacity onPress={() => handleEditSection('/(farmer)/rent-out/availability')}>
                            <Text style={styles.editLink}>Edit</Text>
                        </TouchableOpacity>
                    </View>
                ...
                <View style={styles.infoBox}>
                    ...
                    <Text style={styles.infoText}>
                        By publishing, your listing will be visible to farmers in your area. You can manage bookings and availability from your dashboard.
                    </Text>
                </View>
            ...
            <View style={styles.footer}>
                ...
                <TouchableOpacity style={styles.addAnotherButton} onPress={() => router.push('/(farmer)/rent-out/add-machine')}>
                    <MaterialIcons name="add-circle" size={20} color={COLORS.textSecondary} />
