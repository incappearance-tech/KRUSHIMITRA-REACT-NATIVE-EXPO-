        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.cardContainer}>
                    ...
                    <View style={styles.cardContent}>
                        ...
                        <View style={styles.rateRow}>
                            ...
                            <Text style={styles.rateValue}>₹{labour.price}<Text style={styles.rateUnit}>/day</Text></Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.infoBox}>
                    <MaterialIcons name="info" size={20} color="#6b7280" style={{ marginTop: 2 }} />
                    <Text style={styles.infoText}>
                        <Text style={styles.bold}>Offline Communication Only.</Text> There is no in-app chat available. Please contact {labour.name.split(' ')[0]} directly using the buttons below.
                    </Text>
                </View>
