        ...
        <View style={styles.section}>
          ...
          <View style={styles.segmentContainer}>
            <TouchableOpacity
              style={[
                styles.segmentBtn,
                avail === 'Today' && styles.segmentBtnActive,
              ]}
            ...
            >
              <Text
                style={[
                  styles.segmentText,
                  avail === 'Today' && styles.segmentTextActive,
                ]}
              >
                Today
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.segmentBtn,
                avail === 'Tomorrow' && styles.segmentBtnActive,
              ]}
            ...
            >
              <Text
                style={[
                  styles.segmentText,
                  avail === 'Tomorrow' && styles.segmentTextActive,
                ]}
              >
                Tomorrow
              </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.grid3}>
            <TouchableOpacity
              style={[
                styles.prefCard,
                timePref === 'Day' && styles.prefCardActive,
              ]}
            ...
            >
              <MaterialIcons
                name="wb-sunny"
                size={32}
                color={timePref === 'Day' ? '#15803d' : '#9ca3af'}
              />
              <Text
                style={[
                  styles.prefText,
                  timePref === 'Day' && styles.prefTextActive,
                ]}
              >
                Day
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.prefCard,
                timePref === 'Night' && styles.prefCardActive,
              ]}
            ...
            >
              <MaterialIcons
                name="bedtime"
                size={32}
                color={timePref === 'Night' ? '#4338ca' : '#9ca3af'}
              />
              <Text
                style={[
                  styles.prefText,
                  timePref === 'Night' && styles.prefTextActive,
                ]}
              >
                Night
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.prefCard,
                timePref === 'Both' && styles.prefCardActive,
              ]}
            ...
            >
              <MaterialIcons
                name="contrast"
                size={32}
                color={timePref === 'Both' ? '#000' : '#9ca3af'}
              />
              <Text
                style={[
                  styles.prefText,
                  timePref === 'Both' && styles.prefTextActive,
                ]}
              >
                Both
              </Text>
