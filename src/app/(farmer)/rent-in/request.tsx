          ...
          <View style={styles.card}>
            <View style={styles.toggleRow}>
              <TouchableOpacity
                style={[
                  styles.toggleBtn,
                  durationUnit === 'Hours' && styles.toggleBtnActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.toggleText,
                    durationUnit === 'Hours' && styles.toggleTextActive,
                  ]}
                >
                  Hours
                </Text>
              ...
              <TouchableOpacity
                style={[
                  styles.toggleBtn,
                  durationUnit === 'Days' && styles.toggleBtnActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.toggleText,
                    durationUnit === 'Days' && styles.toggleTextActive,
                  ]}
                >
                  Days
                </Text>
