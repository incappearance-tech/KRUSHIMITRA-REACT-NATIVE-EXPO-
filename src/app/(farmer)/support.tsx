      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Our team is available 24/7 to support your farming business needs.
          </Text>
        </View>
        ...
        <View style={styles.grid}>
          <TouchableOpacity style={styles.supportCard} onPress={handleCall}>
            <View
              style={[styles.cardIcon, { backgroundColor: COLORS.infoLight }]}
            >
          ...
          <TouchableOpacity
            style={[styles.supportCard, { width: '100%' }]}
            onPress={handleEmail}
          >
            <View
              style={[styles.cardIcon, { backgroundColor: COLORS.dangerLight }]}
            >
              <MaterialIcons name="email" size={24} color={COLORS.danger} />
            </View>
            <View style={{ flex: 1 }}>
        ...
        <View style={styles.faqCard}>
          ...
          <Text style={styles.faqAnswer}>
            Go to &apos;Sell/Rent&apos; tab, choose &apos;Rent Out&apos;, and
        ...
        <View style={styles.faqCard}>
          ...
          <Text style={styles.faqAnswer}>
            Yes, all payments are held in escrow until the service is completed.
          </Text>
        </View>
      </ScrollView>
    </View>
...
const styles = StyleSheet.create({
  ...
  cardValue: { fontSize: 13, fontWeight: '800', color: COLORS.text },
  faqTitle: {
    fontSize: 18,
    fontWeight: '800',
    color: COLORS.text,
  ...
  faqQuestion: { fontSize: 15, fontWeight: '700', color: COLORS.text },
  faqAnswer: {
    fontSize: 13,
    color: COLORS.textSecondary,
    marginTop: 6,
