        ...
        >
          ...
          <View style={styles.sectionHeader}>
            <Text style={styles.mainHeading}>
              {t('purchase_confirmation.headline')}
            </Text>
            <Text style={styles.subHeading}>
              {t('purchase_confirmation.subheading')}
            </Text>
          </View>
          ...
          <View style={styles.itemCard}>
            <View style={styles.cardRow}>
              ...
              <View style={styles.itemInfo}>
                ...
                <Text style={styles.itemMeta}>
                  Seller: Ravi Kumar • posted 2d ago
                </Text>
              </View>
            </View>
            ...
            <TouchableOpacity style={styles.viewListingBtn}>
              ...
              <Text style={styles.viewListingText}>
                {t('purchase_confirmation.view_listing')}
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.reasonSection}>
            <Text style={styles.reasonLabel}>
              {t('purchase_confirmation.reason_label')}
            </Text>
