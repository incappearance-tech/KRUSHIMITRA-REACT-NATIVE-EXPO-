...
function ContactContent() {
  ...
  const handleWhatsApp = () =>
    Linking.openURL(
      `whatsapp://send?phone=${9527398933}&text=${encodeURIComponent(t('contact_success.whatsapp_message', { defaultValue: 'Hello, I am interested in your John Deere tractor.' }))}`,
    );
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.machineMiniCard}>
          ...
          <View style={styles.miniInfo}>
            <Text style={styles.miniTitle} numberOfLines={1}>
              John Deere 5050D - 2018
            </Text>
            <Text style={styles.miniId}>
              {t('contact_success.machine_id', { id: '#TR-8821' })}
            </Text>
          </View>
        ...
        <View style={styles.infoBox}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.infoTitle}>
              {t('contact_success.deal_offline')}
            </Text>
        ...
        <View style={styles.safetyHeader}>
          ...
          <Text style={styles.safetyTitleText}>
            {t('contact_success.safety_tips')}
          </Text>
        </View>
        <View style={styles.safetyList}>
          <SafetyItem
            ...
            text={t('contact_success.safety_item_1')}
          />
          <SafetyItem
            icon="payments"
            color={COLORS.danger}
            text={t('contact_success.safety_item_2')}
          />
          <SafetyItem
            icon="description"
            color={COLORS.info}
            text={t('contact_success.safety_item_3')}
          />
        </View>
