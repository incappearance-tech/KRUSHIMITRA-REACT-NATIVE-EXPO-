...
function InspectionContent() {
  ...
  const INSPECTION_ITEMS: IInspectionItem[] = [
    {
      id: 1,
      title: t('inspection_guide.items.engine.title'),
      desc: t('inspection_guide.items.engine.desc'),
      icon: 'engineering',
    },
    {
      id: 2,
      title: t('inspection_guide.items.oil.title'),
      desc: t('inspection_guide.items.oil.desc'),
      icon: 'opacity',
    },
    {
      id: 3,
      title: t('inspection_guide.items.vibration.title'),
      desc: t('inspection_guide.items.vibration.desc'),
      icon: 'vibration',
    },
    {
      id: 4,
      title: t('inspection_guide.items.tyres.title'),
      desc: t('inspection_guide.items.tyres.desc'),
      icon: 'tire-repair',
    },
    {
      id: 5,
      title: t('inspection_guide.items.repairs.title'),
      desc: t('inspection_guide.items.repairs.desc'),
      icon: 'build',
    },
    {
      id: 6,
      title: t('inspection_guide.items.documents.title'),
      desc: t('inspection_guide.items.documents.desc'),
      icon: 'description',
    },
  ];
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroContainer}>
          <ImageBackground
            source={{
              uri: 'https://images.unsplash.com/photo-1530333271403-997576f3068e?q=80&w=600',
            }}
          ...
          >
            <View style={styles.heroOverlay}>
              <Text style={styles.heroTag}>
                {t('inspection_guide.safety_first')}
              </Text>
              <Text style={styles.heroText}>
                {t('inspection_guide.inspect_before_buy')}
              </Text>
            </View>
          </ImageBackground>
        </View>
        ...
        <View style={styles.introSection}>
          <Text style={styles.mainTitle}>
            {t('inspection_guide.check_points')}
          </Text>
          <Text style={styles.subTitle}>
            {t('inspection_guide.verify_condition')}
          </Text>
        </View>
        ...
        <View style={styles.disclaimer}>
          ...
          <Text style={styles.disclaimerText}>
            <Text style={{ fontWeight: '700' }}>
              {t('inspection_guide.disclaimer')}
            </Text>{' '}
            {t('inspection_guide.disclaimer_desc')}
          </Text>
        </View>
      </ScrollView>
