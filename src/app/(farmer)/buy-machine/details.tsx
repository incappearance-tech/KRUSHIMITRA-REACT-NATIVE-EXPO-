...
const MACHINE_MEDIA = [
  {
    id: '1',
    type: 'image',
    uri: 'https://images.unsplash.com/photo-1594411127027-02488e0e0f3e?q=80&w=1000',
  },
  {
    id: '2',
    type: 'video',
  ...
  },
  {
    id: '3',
    type: 'image',
    uri: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?q=80&w=1000',
  },
  {
    id: '4',
    type: 'image',
    uri: 'https://images.unsplash.com/photo-1605000797499-95a51c5269ae?q=80&w=1000',
  },
  {
    id: '5',
    type: 'image',
    uri: 'https://images.unsplash.com/photo-1589923188900-85dae523342b?q=80&w=1000',
  },
];
      ...
      >
        ...
        <View style={styles.imageContainer}>
          {activeMedia.type === 'video' ? (
            ...
            <Image source={{ uri: activeMedia.uri }} style={styles.mainImage} />
          )}
          ...
          <View style={styles.photoCount}>
            ...
            <Text style={styles.photoCountText}>
              ...
              {t('buy_machine_details.see_photos', {
                count: MACHINE_MEDIA.length,
              })}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.contentPadding}>
          <View style={styles.badgeRow}>
            <View style={styles.verifiedBadge}>
              ...
              <Text style={styles.verifiedText}>
                {t('buy_machine_details.verified_listing')}
              </Text>
            </View>
          ...
          <Text style={styles.location}>
            {t('buy_machine_details.located_in', { location: 'Fresno, CA' })}
          </Text>
          ...
          <View style={styles.safetyBox}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.safetyTitle}>
                {t('buy_machine_details.safety_first')}
              </Text>
              <Text style={styles.safetyDesc}>
                {t('buy_machine_details.safety_desc')}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.specsGrid}>
            ...
            <SpecItem
              label={t('buy_machine_details.engine_power')}
              value="50 HP"
            />
            <SpecItem
              label={t('buy_machine_details.hours_used')}
              value="2,500 Hrs"
            />
            <SpecItem
              label={t('buy_machine_details.tyre_condition')}
              value="80% New"
            />
          </View>
          ...
          <View style={styles.listDetails}>
            <DetailRow
              label={t('buy_machine_details.availability')}
              value={t('sell_machine.immediately')}
              isGreen
            />
            <DetailRow
              label={t('buy_machine_details.rc_available')}
              value={t('common.success')}
            />
            <DetailRow
              label={t('buy_machine_details.insurance')}
              value="Valid till Dec 2024"
            />
          </View>

          {/* Selling Reason */}
          <Text style={styles.subHeading}>
            {t('buy_machine_details.selling_reason')}
          </Text>
          <View style={styles.quoteBox}>
            <Text style={styles.quoteText}>
              &quot;Upgrading to a higher HP model for new farming
              equipment.&quot;
            </Text>
          </View>
          ...
          <TouchableOpacity style={styles.mapCard} activeOpacity={0.9}>
            <Image
              source={{
                uri: 'https://maps.googleapis.com/maps/api/staticmap?center=Fresno,CA&zoom=13&size=600x300&maptype=roadmap&markers=color:green%7Clabel:S%7CFresno,CA&key=YOUR_API_KEY_MOCK',
              }}
              style={styles.mapImg}
            />
          ...
          <Text style={styles.mapDisclaimer}>
            {t('buy_machine_details.map_disclaimer')}
          </Text>
        </View>
      </ScrollView>
...
const DetailRow = ({
  ...
  <View style={styles.detailRow}>
    ...
    <View style={isGreen ? styles.statusBadge : null}>
      <Text style={[styles.detailValue, isGreen && styles.statusText]}>
        {value}
      </Text>
    </View>
  </View>
