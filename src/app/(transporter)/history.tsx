...
export default function TripHistoryScreen() {
    ...
    const historyTrips = leads.filter(l => l.status === 'completed' || l.status === 'accepted');
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
                {historyTrips.length > 0 ? (
                        ...
                        <View key={trip.id} style={styles.tripCard}>
                            ...
                            <View style={styles.routeContainer}>
                                ...
                                <View style={styles.locations}>
                                    <Text style={styles.locText} numberOfLines={1}>{trip.pickupLocation}</Text>
                                    <Text style={[styles.locText, { marginTop: 16 }]} numberOfLines={1}>{trip.dropLocation}</Text>
                                </View>
                            </View>
                    ...
                    <View style={styles.emptyState}>
                        ...
                        <Text style={styles.emptySub}>When you complete trips for farmers, they will appear here as part of your history.</Text>
                    </View>
                )}
            </ScrollView>
        </View>
...
const styles = StyleSheet.create({
    ...
    statusBadge: { alignSelf: 'flex-start', backgroundColor: '#dcfce7', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 4 },
