...
const VEHICLE_TYPES = ['Tractor Trolley', 'Mini Truck', 'Large Truck', 'Tempo', 'Thresher'];
...
export default function EditVehicleScreen() {
    ...
    const handleUpdateVehicle = () => {
        if (!vehicleData.model || !vehicleData.number || !vehicleData.capacity || !driverData.name || !driverData.phone) {
    ...
    return (
        <View style={styles.container}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.grid}>
                        {VEHICLE_TYPES.map((type) => (
                            <TouchableOpacity
                                key={type}
                                style={[styles.chip, vehicleData.type === type && styles.chipSelected]}
                                onPress={() => setVehicleData({ ...vehicleData, type })}
                            >
                                <Text style={[styles.chipText, vehicleData.type === type && styles.chipTextSelected]}>{type}</Text>
                            </TouchableOpacity>
                        ))}
                    </View>
                    ...
                    <LabeledInput
                        ...
                        onChangeText={(text) => setVehicleData({ ...vehicleData, number: text })}
            ...
            <View style={styles.footer}>
                <Button label="Save Changes" onPress={handleUpdateVehicle} icon="save" />
            </View>
        </View>
    );
}
