            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
                {payments.length > 0 ? (
                    ...
                    <View style={styles.emptyState}>
                        ...
                        <Text style={styles.emptySubText}>Receipts will appear here once you register a vehicle plan.</Text>
                    </View>
                )}
            </ScrollView>
        </View>
...
const styles = StyleSheet.create({
    ...
    paymentCard: { backgroundColor: '#fff', borderRadius: 16, padding: 16, marginBottom: 16, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8 },
    cardHeader: { flexDirection: 'row', alignItems: 'center', gap: 12 },
    typeIcon: { width: 40, height: 40, borderRadius: 12, backgroundColor: COLORS.brand.muted, alignItems: 'center', justifyContent: 'center' },
    ...
    emptyText: { fontSize: 18, fontWeight: '700', color: COLORS.text, marginTop: 20 },
    emptySubText: { fontSize: 14, color: COLORS.textSecondary, textAlign: 'center', marginTop: 8, paddingHorizontal: 40 },
});
