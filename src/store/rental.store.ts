...
export const useRentalStore = create<RentalStore>((set) => ({
    rentals: [
        {
            ...
            visible: true,
            expired: false,
            image: 'https://images.unsplash.com/photo-1595246140625-573b715e11d3?q=80&w=600',
        ...
        },
        {
            ...
            visible: true,
            expired: false,
            image: 'https://images.unsplash.com/photo-1530267981375-f0de93bf3e94?q=80&w=600',
        ...
        },
        {
            ...
            visible: false,
            expired: true,
            image: 'https://images.unsplash.com/photo-1563205764-59e2b9631b7e?q=80&w=600',
            ownerName: 'Rahul Kumar',
            location: 'Satara',
            distance: '1.8 km',
            rating: 4.9
    ...
    requests: [
        {
            ...
            machineImage: 'https://images.unsplash.com/photo-1595246140625-573b715e11d3?q=80&w=600',
    ...
    removeRental: (id) => set((state) => ({
        rentals: state.rentals.filter(r => r.id !== id)
    })),
    toggleRentalVisibility: (id) => set((state) => ({
        rentals: state.rentals.map(r => r.id === id ? { ...r, visible: !r.visible } : r)
    })),
    setDraftRental: (draft) => set((state) => ({
